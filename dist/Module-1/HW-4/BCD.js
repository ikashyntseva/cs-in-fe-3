...
class BCD extends Adder {
    ...
    get length() {
        return (0, helpers_js_1.getNumberLength)(this.number);
    }
    valueOf() {
    ...
    *ranks() {
        for (const [numInd, num] of this.numbers.entries()) {
            ...
            while (pos < this._defaultBcdDigitsLimit) {
                ...
                if (!isSign) {
                    let rank = (num & (0, helpers_js_1.getMask)(pos)) >>> (pos * this._bcdDigitSize);
    ...
    add(addend) {
        ...
        const max = Math.max((0, helpers_js_1.getNumberLength)(number), (0, helpers_js_1.getNumberLength)(addend));
