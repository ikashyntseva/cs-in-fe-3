...
Если число не помещается в 7 цифр создается новый эдемент массива
...
console.log(n.valueOf()); // 0b0110_0101_0101_0011_0110 или 415030
...
2. Сумма без переносов: 2 ^ 24 = 26 (11010)
   Биты переноса: 2 & 24 = 0 (сдвиг на 1 разряд влево необязателен, отсутствует перенос)
   Нет битов переноса, прекращаем итерацию, итоговая сумма 26 (11010).

```typescript
const n = new BCD(10);

console.log(n.add(15)); // 0b0010_0101 или 37

console.log(n.substract(10)); // 0b0001_0000 или 16

console.log(n.substract(-10)); // 0b0010_0101 или 37 т.к. минус на минус дал плюс
```
